...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        {
            // Note: we are using a fixed-sized frame_buffer for simplicity here. See ImGuiInputTextFlags_CallbackResize
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        if (ImGui::BeginChild("scrolling", ImVec2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            {
                // The simplest and easy way to display the entire frame_buffer:
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    {
    case 0:
        // Single call to TextUnformatted() with a big frame_buffer
